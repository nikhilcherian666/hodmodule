...
<div id="page-wrapper">   
	...
	<form id="editstaff" name="form1" method="post" action="../controller/change_update_faculty.php" enctype="multipart/form-data">
...
<?php
	...
	$r=$obj->fetch_single_faculty_details($staffid);
    foreach($r as $row)
    {
?>
