				...
				<div class=".col-sm-6 .col-md-5 .col-md-offset-2 .col-lg-6 .col-lg-offset-0">
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						if(isset($_POST["clsid"])){
							...
							$sql =$conn->query("select * from subject_class where classid='$classid'");
							while($dat=$sql->fetch_array())
							{
								...
								<td><a href="../controller/remove_subject.php?subjectid=<?php echo $subjectid ;?>&classid=<?php echo $classid;?>" onclick="return confirm('Are you sure to delete?');">REMOVE</a>
									<?php echo "  |  ";?><a href="subject_edit.php?subid=<?php echo $subjectid ;?>&classid=<?php echo $classid;?>">EDIT</a>
									<?php echo "  |  ";?><a href="co_view.php?subid=<?php echo $subjectid ;?>">CO</a>
									<?php echo "  |  ";?><a href="co_po_view.php?subid=<?php echo $subjectid ;?>">CO-PO</a>									
								</td>
