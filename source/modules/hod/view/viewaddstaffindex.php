...
$fdata=$obj->faculty_viewaddedfaculty($depname);
?>
...
<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
  ...
  <tr>
			...
			echo "<td>";			
?>
			<a href="edit_faculty.php?staffid=<?php echo $staffid;?>" >EDIT </a></td>			
			<td><a href="../controller/delete_faculty.php?staffid=<?php echo $staffid;?>" onclick="return confirm('Are you sure to delete?');">DELETE</a></td>
			</tr>
