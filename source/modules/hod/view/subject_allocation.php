...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header" align="center"><span>Subject Allocation
      </span></h1>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-lg-12">
     ...
     <form id="suballoc" action = "../controller/subject_alloc.php" method = "POST" enctype = "">
  ...
  <td>
   <div id ="data2">
    ...
    //  $r=mysql_fetch_assoc($l);
      ...
      $r=$conn->query("select * from faculty_details where name like '$name%' and fid not like 'DUMMY%' ");
     while($result=$r->fetch_array()){     
